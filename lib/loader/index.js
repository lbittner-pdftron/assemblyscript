...
function postInstantiate(baseModule, instance) {
  const rawExports = instance.exports || instance;
...
/** Instantiates an AssemblyScript modul*/
    ...
    if (hash >= 0) {
      ...
      if (/^(get|set):/.test(name)) {
        if (!hasOwnProperty(curr, name = name.substring(4))) {
          let getter = exports[internalName.replace("set:", "get:").replace('set_', 'get_')];
          let setter = exports[internalName.replace("get:", "set:").replace('get_', 'set_')];
      ...
      if (/^(get|set):/.test(name)) {
        if (!hasOwnProperty(curr, name = name.substring(4))) {
          Object.defineProperty(curr, name, {
            get: exports[internalName.replace("set:", "get:").replace('set_', 'get_')],
            set: exports[internalName.replace("get:", "set:").replace('get_', 'set_')],
            enumerable: true
          });
        }
